...
public OnPluginStart()
{
	...
	g_hCvarRandom =		CreateConVar(	"l4d2_gnome_random",		"2",			"-1=All, 0=None. Otherwise randomly select this many gnomes to spawn from the maps confg.", CVAR_FLAGS );
	g_hCvarSafe =		CreateConVar(	"l4d2_gnome_safe",			"1",			"On round start spawn the gnome: 0=Off, 1=In the saferoom, 2=Equip to random player.", CVAR_FLAGS );
	g_hCvarTemp =		CreateConVar(	"l4d2_gnome_temp",			"0",			"-1=Add temporary health, 0=Add to main health. Values between 1 and 100 creates a chance to give main health, else temp health.", CVAR_FLAGS );
